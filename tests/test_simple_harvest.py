...
def test_simple_harvest(
    ...
    staking_before_harvest = sorbettiere.userInfo(pool_id, strategy)[0]
    ...
    assert sorbettiere.userInfo(pool_id, strategy)[0] > staking_before_harvest
    ...
    # try and include custom logic here to check that funds are in the staking contract (if needed)
    assert sorbettiere.userInfo(pool_id, strategy)[0] > 0
